...
// import { batchRenamer } from "./batch-renamer.service.ts";
  ...
  return (
    <section className="tool-view">
      ...
      <div className="tool-heading">
        <span className="tool-heading-icon"><ArrowsClockwise weight="duotone" /></span>
        <div>
          <p className="eyebrow">Productividad</p>
          <h1>Renombrar archivos</h1>
          <p>Renombra grupos de archivos con reglas reutilizables.</p>
        </div>
      </div>
